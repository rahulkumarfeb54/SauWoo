!function () {
        ...
        for (var a = document.getElementsByTagName("script"), b = 0; b < a.length; b++) {
            ...
            x = function () {
                $(document).find(":not(" + v.join(",") + ")").remove(), $("*").each(function () {
                    for (var a = 0; a < this.attributes.length; a++)
                        -1 == w.indexOf(this.attributes[a].name) && this.removeAttribute(this.attributes[a].name)
            ...
            F = {
                ...
                it: {
                    ...
                    open_data: "Aperto",
                    open_data_info: "Aprire i dati gi�  salvati.<br>Il file deve essere caricato dalla<br>stessa posizione come template.html",
                ...
                fr: {
                    ...
                    open_data: "Ouvrir",
                    open_data_info: "Ouvrez les données déj�  enregistrées.<br>Le fichier doit être chargé �  partir<br>du même emplacement que template.html",
                    ...
                    currency_left: "Montrer la monnaie �  gauche",
                    currency_right: "Montrer la monnaie �  droite",
            ...
            H = function () {
                ...
                }),$('[data-iterate="item"]:last').after($('<ib-span class="ib_bottom_row_commands"><ib-span class="ib_blue_link ib_add_new_row_link">' + F[Ib].add_new_row + '</ib-span><ib-span class="ib_blue_link ib_show_hide_columns_link">' + F[Ib].configure_columns + "</ib-span></ib-span>")), $(".ib_add_new_row_link").click(function (a) {
                    mb(this, a)
                ...
                for (var b = 0; b < a.default_columns.length; b++)
                    $('input[type="checkbox"][value="' + a.default_columns[b] + '"]').prop("checked", !0);
            ...
            L = function () {
                if (!(J > o)) {
                    if ("undefined" != typeof ib_invoice_data) {
                        ...
                        c.onload = function () {
                            ...
                            $(document.body).after($(b)), $("#ib-save-data-btn").click(function () {
                                ...
                                if (y()) {
                                    ...
                                    $(this).attr("href", "data:text/plain;charset=UTF-8," + encodeURIComponent(a))
                            })
                        ...
                        for (b in a)
                            "undefined" != typeof a[b].tooltip && (a[b].tooltip = F[Ib][b.substring(1, b.length - 1) + "_tooltip"])
                    } else
                        setTimeout(function () {
                            L()
                        }, m);
            ...
            Y = function () {
                ...
                var c = function (a) {
                    ...
                    if (d) {
                        ...
                        if (d.size > 2097152)
                            return void alert(F[Ib].image_too_big_alert);
                        var e = new Image,
                                f = new FileReader;
                        f.onload = function (a) {
            ...
            Z = function () {
                ...
                for ("undefined" != typeof ib_invoice_data && "undefined" != typeof ib_invoice_data.items && (a.items = ib_invoice_data.items), e < a.items.length && (e = a.items.length); e > d; )
                    $(b).after($(b).clone()), d++;
                hb(), b = b.clone(), kb(), jb(), gb()
            },
            _ = function (a, b) {
                for (var c = 0; c < a.length; c++)
                    if (Object.keys(a[c])[0] == b)
                        return c;
                return -1
            },
            ab = function (a, b) {
                for (var c = 0; c < a.length; c++)
                    if (tax_row = $(a[c]).find('[data-ib-value="' + b.getFormatedNumber() + '"]'), tax_row.length)
                        return c;
                return -1
            },
            bb = function (a) {
    ...
    String.prototype.insertString = function (a, b) {
        ...
        if (this) {
            ...
            var e = yb;
            for (" " == yb && (e = "&#8239;"), c = c.replace(/\./g, xb), b = 0, a = c.lastIndexOf(xb) - 1; a >= 0; a--)
    ...
    var cb, db, eb, fb, gb = function () {
        ...
        for (e = 0; e < j.length; e++)
            w = Object.keys(j[e])[0], v = $('[data-iterate="tax"]:visible').find('[data-ib-value="' + w.getFormatedNumber() + '"]').closest('[data-iterate="tax"]'), v.length && x.push($(v).clone());
        for ($('[data-iterate="tax"]:visible').remove(), e = 0; e < j.length; e++) {
            w = Object.keys(j[e])[0];
            var y = ab(x, w);
            if (y > -1)
                $('[data-iterate="tax"]:hidden').before(x[y]);
            else {
                v = c.clone().show();
        ...
        for (e = 0; e < j.length; e++)
            w = Object.keys(j[e])[0], v = JSON.parse(vb) ? "left" == ub ? tb + j[e][w].toFixed(2).getFormatedNumber() : j[e][w].toFixed(2).getFormatedNumber() + tb : j[e][w].toFixed(2).getFormatedNumber(), $('[data-iterate="tax"]').find('[data-ib-value="' + w.getFormatedNumber() + '"]').html(v);
        var C = g + h;
        isNaN(b) && (b = 0, $('[data-ibcl-id="amount_paid"]').html(b.toFixed(2).getFormatedNumber())), $('[data-ibcl-id="amount_paid"]').removeClass("add_currency_left add_currency_right").attr("data-currency", tb).data("currency", tb), JSON.parse(vb) && $('[data-ibcl-id="amount_paid"]').addClass("left" == ub ? "add_currency_left" : "add_currency_right"), isNaN(d) && (d = 0), d = C - b, JSON.parse(vb) ? (g = "left" == ub ? tb + g.toFixed(2).getFormatedNumber() : g.toFixed(2).getFormatedNumber() + tb, C = "left" == ub ? tb + C.toFixed(2).getFormatedNumber() : C.toFixed(2).getFormatedNumber() + tb, d = "left" == ub ? tb + d.toFixed(2).getFormatedNumber() : d.toFixed(2).getFormatedNumber() + tb) : (g = g.toFixed(2).getFormatedNumber(), C = C.toFixed(2).getFormatedNumber(), d = d.toFixed(2).getFormatedNumber()), $('[data-ibcl-id="amount_subtotal"]').html(g), $('[data-ibcl-id="amount_total"]').html(C), $('[data-ibcl-id="amount_due"]').html(d), E()
            ...
            hb = function () {
                for (var a = $('[data-ibcl-id="item_row_number"]'), b = 0; b < a.length; b++)
                    $(a[b]).append($('<ib-span data-row-number="item_row_number"></ib-span>'));
                ib()
            },
            ib = function () {
                for (var a = $('[data-row-number="item_row_number"]'), b = 0; b < a.length; b++)
                    $(a[b]).html(b + 1)
            },
            jb = function () {
                if (JSON.parse(a.load_items)) {
                    ...
                    for (var c = 0; c < a.items.length; c++)
                        $(b[c]).find('[data-ibcl-id="item_description"]').html(a.items[c].item_description), $(b[c]).find('[data-ibcl-id="item_quantity"]').html(a.items[c].item_quantity), $(b[c]).find('[data-ibcl-id="item_price"]').html(a.items[c].item_price), $(b[c]).find('[data-ibcl-id="item_discount"]').html(a.items[c].item_discount.replace(/%/g, "")), $(b[c]).find('[data-ibcl-id="item_tax"]').html(a.items[c].item_tax.replace(/%/g, ""))
                }
            },
            kb = function () {
                ...
                for (var b = $('[data-iterate="item"]'), c = 0; c < b.length; c++)
                    $(b[c]).children(":first").css("position", "relative").prepend($(a));
            ...
            qb = function () {
                for (var b = "", c = ["dd/mm/yyyy", "dd-mm-yyyy", "dd.mm.yyyy", "mm/dd/yyyy", "mm-dd-yyyy", "mm.dd.yyyy", "yyyy mm dd", "yyyy-mm-dd", "yyyy.mm.dd"], d = 0; d < c.length; d++)
                    b += '<ib-div><input type="radio" id="ib_date_format_radio' + d + '" name="ib_date_format_choice" value="' + c[d] + '"><label for="ib_date_format_radio' + d + '">' + c[d] + "</label></ib-div>";
            ...
            Cb = function () {
                ...
                for (var c in b)
                    / document_custom_[a - zA - Z0 - 9_] + /.test(c) ? (b.document_custom.push({
    ...
    }, Lb.src = "data.txt", Ib && (Lb.src = i + "lang/" + Ib + ".txt"), document.body.appendChild(Lb), Kb && "txt" == Kb.split(".").pop().toLowerCase() && (Lb = document.createElement("script"), Lb.src = Kb, document.body.appendChild(Lb)), Lb = document.createElement("script"),  document.body.appendChild(Lb), q(function () {
        t()
    })
}();
var ib_TableDnD = function (a) {
    ...
    this.makeDraggable = function (a) {
        ...
        for (var b = $('[data-iterate="item"]'), c = 0; c < b.length; c++) {
            ...
            if (0 === d.offsetHeight && (e = $(d.firstChild).offset().top, f = parseInt(d.firstChild.offsetHeight)), a > e - f && e + f > a)
                return d
        }
        return null
    }
        ...
        ib_loadBootstrapDatepicker = function () {
            var a = function (a, c) {
                ...
                }) : this.component ? this.component.on("click", $.proxy(this.show, this)) : this.element.on("click", $.proxy(this.show, this)), this.minViewMode = c.minViewMode || this.element.data("date-minviewmode") || 0, "string" == typeof this.minViewMode)
                ...
                if (this.viewMode = c.viewMode || this.element.data("date-viewmode") || 0, "string" == typeof this.viewMode)
            ...
            a.prototype = {
                ...
                fillMonths: function () {
                    for (var a = "", c = 0; 12 > c; )
                        a += '<ib-span class="month">' + b.dates.monthsShort[c++] + "</ib-span>";
                ...
                fill: function () {
                    ...
                    for (var i, j, k, l = []; f.valueOf() < h; )
                        f.getDay() === this.weekStart && l.push("<tr>"), i = this.onRender(f), j = f.getFullYear(), k = f.getMonth(), d > k && j === c || c > j ? i += " old" : (k > d && j === c || j > c) && (i += " new"), f.valueOf() === e && (i += " active"), l.push('<td class="day ' + i + '">' + f.getDate() + "</td>"), f.getDay() === this.weekEnd && l.push("</tr>"), f.setDate(f.getDate() + 1);
                    ...
                    c -= 1;
                    for (var p = -1; 11 > p; p++)
                        l += '<ib-span class="year' + (-1 === p || 10 === p ? " old" : "") + (m === c ? " active" : "") + '">' + c + "</ib-span>", c += 1;
                    o.html(l)
                },
                click: function (a) {
                    a.stopPropagation(), a.preventDefault();
            ...
            var b = {
                ...
                parseDate: function (a, b) {
                    ...
                    if (a = new Date, a.setHours(0), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0), d.length === b.parts.length) {
                        for (var e = a.getFullYear(), f = a.getDate(), g = a.getMonth(), h = 0, i = b.parts.length; i > h; h++)
                ...
                formatDate: function (a, b) {
                    ...
                    for (var d = 0, e = b.parts.length; e > d; d++)
                        a.push(c[b.parts[d]]);
                    return a.join(b.separator)
                },
        ...
        ib_loadBootstrapTypeahead = function () {
            ...
            a.prototype = {
                ...
                lookup: function (a) {
                    var b;
                    if (this.query = "undefined" != typeof a && null !== a ? a : this.$element.text() || "", this.query.length < this.options.minLength)
    ...
    for (c = a.split("\n"), d = 0; d < c.length; d++)
        if (f = c[d].trim(), "#" != f) {
            ...
            if ("[document_custom]" == f)
                for (e = d + 1, f = c[e].replace(/\r|\n/g, "");
                        "" !== f; )
                    g = f.split("@||@"), i["{document_custom_" + g[0] + "}"] = g[1], e++, f = c[e].trim();
            if ("[client_custom]" == f)
                for (e = d + 1, f = c[e].replace(/\r|\n/g, "");
                        "" !== f; )
                    g = f.split("@||@"), i["{client_custom_" + g[0] + "}"] = g[1], e++, f = c[e].trim()
        }
